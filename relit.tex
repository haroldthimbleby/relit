...
\def\myinput#1{\global\edef\listOfFiles{\listOfFiles \noindent #1 \vskip 1pt }%
...
\newpage
\section*{List of included files (to be sure what to upload to Elsevier)}
This list is the included files in order as they are used in the document. There are repetitions. \vskip 2ex

\listOfFiles

Also need these to be able to generate a PDF:
...
Note that relit.bib and relit.tex are not deleted by make clean

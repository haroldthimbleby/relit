...
(void) printf("Hello reverse literate programming!\char'134n");\\
...
Makefile-target TeX-mode-demo.tex-target euler.c-target euler.c-tagged.txt-target hello.c-target randomised-euler.c-target relit-def.tex-target sedcommands-target define-non-randomised-cycle-target: eulerPaper.tex relit  
	./helpMake Makefile TeX-mode-demo.tex euler.c euler.c-tagged.txt hello.c randomised-euler.c relit-def.tex sedcommands define-non-randomised-cycle "./relit -u -v eulerPaper.tex > t"

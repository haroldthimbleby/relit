...
\def\relit{\begingroup\catcode`\^^M=12 \xmymacro}
{\catcode`\^^M=12 %
 \gdef\xmymacro#1^^M{\marginpar{RELIT}{\noindent\tt\hskip -1em\textcolor{red}{* RELIT: #1}}\endgroup}%
}
\def\relit#1{\marginpar{\textcolor{red}{RELIT}}{\noindent\tt\hskip -1em\textcolor{red}{* RELIT: #1}}\\}

%\relit{define code ., /relit.end/-1, <seen>}
...
Feynman \cite{feynman} warned about the utter honesty essential to do good science in 1974, when he said, 
